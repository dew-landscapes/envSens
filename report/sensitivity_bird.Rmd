...
source("../R/sensitivity_functions.R")

path_bp <- "H:/dev/out/envPIA/aus_imcra_prov_dissolve______0__P50Y__sa_br_dissolve/90__90__P1Y__species/pia__boundary__1__0__50000/summarise/sum_tbl.csv"

path_usg <- "H:/dev/out/envPIA/aus_imcra_prov_dissolve______0__P50Y__sa_br_dissolve/90__90__P1Y__species/pia__boundary__2__0__50000/summarise/sum_tbl.csv"

path_birdbase <- "H:/data/envSens/database/data_BIRDBASE v2025.1 Sekercioglu et al. Final.csv"

path_genlength <- "H:/data/envSens/database/Modelled_GenLength_cobi13486-sup-0004-tables4.csv"

path_eoo <- "H:/data/envSens/database/EOO_cobi13486-sup-0003-tables3.csv"

out_path <- "../../out/envSens"
```
...
birdbase <- read.csv(path_birdbase)
...
genlength <- readr::read_csv(path_genlength, col_types = readr::cols()) %>%
...
eoo <- readr::read_csv(path_eoo, col_types = readr::cols(), na = "NA") %>% 
...
## Write into csv
readr::write_csv(bird_table, file.path(out_path, "bird_table.csv"))
```
...
# make_manual_table(df_old = file.path(out_path, "bird_table_sensitivity_mtable_20251124.csv"), 
#                   df_new = bird_table_sensitivity)
  
# joining the manual table to the info table
mtable <- read.csv(file.path(out_path, "bird_table_sensitivity_mtable_20251124-20251202_1203.csv"))
...
write_csv(scored, file.path(out_path, "scored_bird_sensitivity.csv"))
...
path_bioclean <- "//env.sa.gov.au/dfsroot/Projects/Landscapes/prod/out/envCleaned/aus_imcra_prov_dissolve______0__P50Y__sa_br_dissolve/90__90__P1Y__species/clean/objects/bio_clean"

bio_clean <- rio::import(path_bioclean, format = "parquet")
spp <- bio_clean %>% 
