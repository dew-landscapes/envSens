...
birdsens_v2_poolall <- function(
  ...
  dplyr::mutate(
    ...
    index_climate = (score_clim_rangesize + score_clim_breadth + score_clim_elevation)/3,
    ...
    # Migration
    score_cons_mig = scales::rescale(bb_mig_score, to = c(0, 1)),
  ...
  readr::write_csv(
    scored,
    file.path(outpath, "bird_sensitivity_v2.csv")
  )
